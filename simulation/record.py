...
def main():
    ...
    robot_config = LeKiwiClientConfig(remote_ip=args.remote_ip, id=ROBOT_ID)
    ...
    if not robot.is_connected or (not args.use_keyboard and not leader_arm.is_connected) or not keyboard.is_connected:
